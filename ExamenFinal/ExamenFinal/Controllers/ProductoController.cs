...
namespace ExamenFinal.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["idProveedor"] = new SelectList(_context.Set<Proveedor>(), "idProveedor", "idProveedor");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProducto,idProveedor,IdCategoria,PrecioCosto,PrecioVenta,Existencia,NivelNuevoPedido,Suspendido")] Producto producto)
        {
            ...
            ViewData["idProveedor"] = new SelectList(_context.Set<Proveedor>(), "idProveedor", "idProveedor", producto.idProveedor);
            return View(producto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProducto,idProveedor,IdCategoria,PrecioCosto,PrecioVenta,Existencia,NivelNuevoPedido,Suspendido")] Producto producto)
        {
